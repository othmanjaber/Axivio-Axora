...
<table>
  <tr>
    <td width="50%" style="text-align: left;">
      <img src="other/repository images/l298n.jpg" alt="L298N Motor Driver" width="100%">
    </td>
    <td width="50%" style="text-align: left; vertical-align: top;">
      <h3>Specifications:</h3>
...
<table>
  <tr>
    <td width="50%" style="text-align: left;">
      <img src="./other/readme-images/battery.jpg" alt="Power Supply" width="100%">
    </td>
    <td width="50%" style="text-align: left; vertical-align: top;">
      <h3>Specifications:</h3>
...
<table>
  <tr>
    <td width="50%" style="text-align: left;">
      <img src="./other/readme-images/vl53l0x.jpg" alt="VL53L0X" width="100%">
    </td>
    <td width="50%" style="text-align: left; vertical-align: top;">
      <h3>Specifications:</h3>
...
<table>
  <tr>
    <td width="50%" style="text-align: left;">
      <img src="./other/readme-images/pixy2.jpg" alt="Pixy2" width="100%">
    </td>
    <td width="50%" style="text-align: left; vertical-align: top;">
      <h3>Specifications:</h3>
